...
import io.altar.test.model.Shelf;
import io.altar.test.repository.ShelfRepository;

/**
 * 
 * @author <a href="mailto:luismmribeiro@gmail.com">Luis Ribeiro</a>
 */
public class CreateShelfsState extends State {
    public Transition doAction() {
        ...
        ShelfRepository.getInstance().create(s);
        
        return Transition.TO_SHELFS;
    }
}
