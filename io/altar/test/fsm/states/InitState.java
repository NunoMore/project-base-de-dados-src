...
public class InitState extends State {
    ...
    protected void writeOutput() {
        ...
        System.out.println("2 - Listagem de Prateleiras");
    ...
    protected Transition processInput(String line) {
        switch(line) {
        case "1": return Transition.TO_PRODUCTS;
        case "2": return Transition.TO_SHELFS;
        case "3": 
            System.out.println("Obrigado por ter usado esta aplicaçãoproduzida por Luís Ribeiro.");
            System.exit(0);
        default: return null;
        }
    }
